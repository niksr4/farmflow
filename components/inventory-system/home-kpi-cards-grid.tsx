...
export default function HomeKpiCardsGrid({
  ...
  return (
    ...
    >
      {/* Cherry Processed */}
      <Card className="border-stone-200/60 bg-gradient-to-br from-stone-50 to-stone-50/80">
        <CardHeader className="pb-2">
          <div className="flex items-start justify-between gap-2">
            <CardTitle className="text-sm font-medium text-stone-600">Cherry Processed</CardTitle>
      ...
      <Card className="border-stone-200/60 bg-gradient-to-br from-stone-50 to-stone-50/80">
        <CardHeader className="pb-2">
          <div className="flex items-start justify-between gap-2">
            <CardTitle className="text-sm font-medium text-stone-600">Bags at Buyer</CardTitle>
            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-stone-50">
              <svg className="h-3.5 w-3.5 text-stone-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {canShowSales && (
        <>
          <Card className="border-stone-200/60 bg-gradient-to-br from-stone-50 to-stone-50/80">
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between gap-2">
                <CardTitle className="text-sm font-medium text-stone-600">Coffee Sold</CardTitle>
            ...
            <CardContent>
              <p className="text-2xl font-black tabular-nums text-stone-900">{fmt(salesSoldKgsTotal)} kg</p>
      ...
      {costPerKgData.hasData && (
        <Card className="border-stone-200/60 bg-gradient-to-br from-stone-50 to-stone-50/80">
          <CardHeader className="pb-2">
            <div className="flex items-start justify-between gap-2">
              <CardTitle className="text-sm font-medium text-stone-600">Cost per kg</CardTitle>
      ...
      {seasonProjection.hasData && seasonProjection.projectedSeasonTotal !== null && (
        <Card className="border-stone-200/60 bg-gradient-to-br from-stone-50 to-stone-50/80">
          <CardHeader className="pb-2">
            <div className="flex items-start justify-between gap-2">
              <CardTitle className="text-sm font-medium text-stone-600">Season Projection</CardTitle>
              <div className={cn(
