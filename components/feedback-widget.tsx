...
export default function FeedbackWidget({ currentTab }: Props) {
  ...
  return (
    <>
      {/* Panel */}
      {open && (
        <div className="fixed bottom-[136px] left-4 z-50 w-[min(340px,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-black/10 bg-white shadow-[0_20px_60px_-20px_rgba(0,0,0,0.35)] animate-in fade-in slide-in-from-bottom-2 duration-200 sm:bottom-[80px]">
          {/* Header */}
      ...
      {/* Floating trigger — bottom-left, clear of the AI assistant button on bottom-right.
          On mobile, elevated above the bottom nav bar (~60px tall at z-40). */}
      <div className="fixed bottom-[72px] left-4 z-50 sm:bottom-4">
        <button
          type="button"
