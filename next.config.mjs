...
export default withSentryConfig(nextConfig, {
  ...
  // tunnelRoute disabled: Turbopack does not inject the /monitoring route handler,
  // so errors sent to /monitoring return 404 and are silently dropped. With a B2B
  // user base, direct ingest to Sentry's EU endpoint is fine.
